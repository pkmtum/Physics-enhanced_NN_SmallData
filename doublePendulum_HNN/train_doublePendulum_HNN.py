...
plot_loss_curve(train_losses, val_losses, figname="doublePendulum_HNN_loss_curve")
...
pickle_name = path + "doublePendulum_HNN_hreg100_2x128_Data4x1500_params_for_loss_{}.pkl".format(val_loss)
...
plot_hamiltonian_IdMap(xt_test, xt_pred, figname=path + "doublePendulum_HNN_hreg100_2x128_Data4x1500_IdMap.png")
