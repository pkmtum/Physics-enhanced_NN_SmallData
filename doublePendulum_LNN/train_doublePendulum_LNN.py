...
path = F""
pickle_name = path + "doublePendulum_LNN_2x128_Data4x1500_params_for_loss_{}.pkl".format(val_loss)
...
plot_lagrangian_IdMap(xt_test, xt_pred, figname=path + "doublePendulum_LNN_2x128_Data4x1500_IdMap.png")
