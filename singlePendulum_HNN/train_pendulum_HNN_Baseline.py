...
plot_loss_curve(train_losses, val_losses, figname="pendulum_HNN_B_loss_curve")
params = get_params(opt_state)
...
pickle_name = path + "singlePendulum_HNN_B_2x32_Data4x16_params_for_loss_{}.pkl".format(val_loss)
...
plot_hamiltonian_IdMap(xt_test, xt_pred, figname=path + "singlePendulum_HNN_B_2x32_Data4x16_IdMap.png")
